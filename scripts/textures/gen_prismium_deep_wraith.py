#!/usr/bin/env python3
"""Generate the entity texture for Prismium Deep Wraith (session 47), the
dedicated aquatic conversion-target mob for Prismium Wraith (see
PrismiumWraithEntity#doUnderWaterConversion and PROGRESS.md session 47:
the repo owner reported the Wraith turning into a vanilla Drowned after
prolonged submersion and asked for a themed mob instead).
...
PRISMIUM_ACCENT = "#7CFFB8"
PRISMIUM_ACCENT_DARK = "#00542E"
EYE_WHITE = "#C8FBFF"
...
def main():
    ...
    img = make_deep_wraith_texture()
    out_path = ASSETS / "entity" / "prismium_deep_wraith.png"
    img.save(out_path)
    print(f"Wrote {out_path}")

    preview = make_preview(img)
    preview_path = BUILD_DIR / "preview_prismium_deep_wraith.png"
