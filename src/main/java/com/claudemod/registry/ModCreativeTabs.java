    ...
    public static final RegistryObject<CreativeModeTab> CLAUDEMOD_TAB = CREATIVE_MODE_TABS.register("claudemod_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.PRISMIUM_DEEPSTONE_ITEM.get()); // session 72
                        output.accept(ModItems.PRISMIUM_STONE_SLAB_ITEM.get()); // 2026-09-11
                        output.accept(ModItems.PRISMIUM_STONE_WALL_ITEM.get()); // 2026-09-11
                        output.accept(ModItems.PRISMIUM_STONE_STAIRS_ITEM.get()); // 2026-09-11
                        ...
                        output.accept(ModItems.PRISMIUM_ALLOY_BLOCK_WALL_ITEM.get()); // 2026-09-10
                        output.accept(ModItems.PRISMIUM_ALLOY_BLOCK_STAIRS_ITEM.get()); // 2026-09-10
                        output.accept(ModItems.CHISELED_PRISMIUM_ALLOY_BLOCK_ITEM.get()); // scheduled session, 2026-09-18
                        output.accept(ModItems.PALE_PRISMIUM_BLOCK_ITEM.get()); // session #77
                        ...
                        output.accept(ModItems.CHISELED_PALE_PRISMIUM_BLOCK_ITEM.get()); // scheduled session, 2026-09-18
                        ...
                        output.accept(ModItems.PRISMIUM_GEODE_CLUSTER_ITEM.get()); // scheduled session, 2026-09-13
                        ...
                        output.accept(ModItems.PRISMIUM_ALLOY_RAPIER.get()); // session 71
                        ...
                        output.accept(ModItems.PRISMIUM_CRAWLER_SPAWN_EGG.get()); // scheduled session, 5th mob
                        output.accept(ModItems.PRISMIUM_WISP_SPAWN_EGG.get()); // scheduled session, 6th mob
                        ...
                        output.accept(ModItems.PRISMIUM_WALL_LAMP_ITEM.get()); // scheduled session, 2026-09-21
                        ...
                        output.accept(com.claudemod.item.PrismiumCompendiumFactory.createStack());
                    })
                    .build());
